...
function Eyes() {
  ...
  useEffect(() => {
    window.addEventListener("mousemove", (e) => {
      ...
      let detalx = mouseX - window.innerWidth / 2;
      let detalY = mouseY - window.innerHeight / 2;

      let angle = Math.atan2(detalY, detalx) * (180 / Math.PI);
      setRotate(angle - 180);
    });
  });
  return (
    <div className="eyes w-full h-screen overflow-hidden">
      <div className='relative w- full h-screen bg-[url("https://ochi.design/wp-content/uploads/2022/05/Top-Viewbbcbv-1-1440x921.jpg")] bg-cover bg-center'>
